                ...
                <CardContent>
                  <div className="space-y-3">
                    {topGainers.map((currency, index) => (
                      <div key={currency.pair} className="flex justify-between items-center p-3 bg-green-50 rounded-lg border border-green-100 bg-gray-900">
                ...
                <CardContent>
                  <div className="space-y-3">
                    {topLosers.map((currency, index) => (
                      <div key={currency.pair} className="flex justify-between items-center p-3 bg-red-50 rounded-lg border border-red-100 bg-gray-900">
                        <div className="flex items-center gap-3">
